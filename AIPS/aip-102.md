...
Alys sends an ARK blockchain transaction with the instructions:
Lock 300 ARK from my account for Bob, with the following password hash: 
`0f128d401958b1b30ad0d10406f47f9489321017b4614e6cb993fc63913c5454`

### Step 2

After waiting for Alys' transaction to appear on the blockchain, Bob sends a NOS transaction using the same password hash, the instruction reads as 
