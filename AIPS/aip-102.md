---
  ...
  Type: *Standards*
  Category *only required for Standards Track:  Core | Network | Protocol
  Created: *2019-06-27*
  Last Update: *2019-06-27*
  Requires (*optional): AIP-11, AIP-28, AIP-29
--- 
...
![Basic Scenario](../assets/aip-102/basic-scenario.png)
